...
/* Module Version: 5.7 */
/* C:\Program Files\Lattice\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n Div4PLL -lang verilog -synth synplify -arch xo2c00 -type pll -fin 10 -mdiv 1 -ndiv 1 -bypassp -bypass_divp -adiv 4 -phase_cntl STATIC -fb_mode 5  */
/* Mon Jan 17 20:52:43 2022 */


`timescale 1 ns / 1 ps
module Div4PLL (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
